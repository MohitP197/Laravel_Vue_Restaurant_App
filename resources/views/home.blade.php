...
<p>
    Nadia’s Garden Restaurant isn’t just about dining. We’re about creating memorable experiences that
    our guest will cherish!
    Our family friendly restaurant has indoor, outdoor, and intimate dining options for any occasion.
    Our outdoor garden area is perfect for a stroll before or after your meal. We invite you to come
    dine with us!
</p>
...
<div class="menu-categories">
    ...
    <article>
        <a href="/menu#{{ str_slug($category->name) }}"><img src="/images/{{$category->image}}"></a>
        <h2><a href="/menu#{{str_slug($category->name)}}">{{$category->name}}</a></h2>
    </article>
    @empty
    <p>No Categories</p>
    @endforelse
...
<div class="social">
    <div>
        ...
        <p>
            ...
            It’s definitely a place you have to give a few tries to get a feel for everything they have
            to offer.
